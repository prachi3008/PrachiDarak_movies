...
import com.example.moviesapp.common.utils.setAnchorId
import com.example.moviesapp.data.Resource
import com.example.moviesapp.databinding.FragmentMovieListBinding
import com.example.moviesapp.model.Movie
import com.example.moviesapp.ui.home.master.MovieListAdapter
import com.example.moviesapp.ui.home.viewmodel.FavoriteViewModel
import kotlinx.coroutines.flow.collect
import kotlinx.coroutines.launch

class FavoriteFragment : Fragment(R.layout.fragment_movie_list),
    ...
    override fun onItemClick(movie: Movie, container: View) {
        val action = FavoriteFragmentDirections.navigateToMovieDetails(
            id = movie.id,
